	...
	<div>
		...
		<div v-else>
			...
			<p v-if="state === 1">
				...
				<L10n text="Enter your identification (e.g. email address to start the verification):"></L10n>
			...
			<p v-if="state === 2">
				<L10n text="A confirmation code has been sent to {email} via E-Mail. Please insert the code here:"
					  :options="{email: phoneNumber}"></L10n>
			...
			<p v-if="state === 3">
				<L10n text="Your account was successfully configured to receive authentication codes via {displayName}."
					  :options="{displayName: displayName}"/>
