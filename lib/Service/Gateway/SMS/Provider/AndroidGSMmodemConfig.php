...
class AndroidGsmModemConfig implements IProviderConfig {
	...
	public function getUser(): string {
		return $this->getOrFail('android_gsm_modem_username');
	}

	public function setUser(string $user) {
		$this->config->setAppValue(Application::APP_NAME, 'android_gsm_modem_username', $user);
	}

	public function getPassword(): string {
		return $this->getOrFail('android_gsm_modem_password');
	}

	public function setPassword(string $password) {
		$this->config->setAppValue(Application::APP_NAME, 'android_gsm_modem_password', $password);
	}
	...
	public function isComplete(): bool {
		...
		$expected = [
			'android_gsm_modem_username',
			'android_gsm_modem_password',
			'android_gsm_modem_host',
		];
