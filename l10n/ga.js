OC.L10N.register(
    ...
    "Two-Factor Gateway: WhatsApp API authentication failed" : "Geata Dhá Fhachtóir: Theip ar fhíordheimhniú API WhatsApp",
    "The authentication with WhatsApp API has failed. The Two-Factor Gateway (WhatsApp) will not work until this is resolved. Please reconfigure the WhatsApp gateway using the command line tool." : "Theip ar an bhfíordheimhniú le WhatsApp API. Ní oibreoidh an Geata Dhá Fhachtóir (WhatsApp) go dtí go réiteofar é seo. Athchumraigh geata WhatsApp ag baint úsáide as an uirlis líne ordaithe.",
