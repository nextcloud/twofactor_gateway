OC.L10N.register(
    "twofactor_gateway",
    {
    "%s is your authentication code" : "%s je kod za proveru identiteta",
    ...
    "Two-factor gateway providers (SMS, Telegram, Signal)" : "Мрежни пролаз за провајдере двофакторске провере идентитета (SMS, Телеграм, Сигнал)",
    "A set of Nextcloud two-factor providers to send authentication codes via Signal, SMS and Telegram." : "Скуп провајдера двофакторске провере идентитета којима треба послати кодове за проверу идентитета преко Сигнала, SMS-а и Телеграма.",
