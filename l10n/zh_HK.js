OC.L10N.register(
    ...
    "Two-factor gateway providers (SMS, Telegram, Signal)" : "雙重認證通訊閘提供者（SMS， Telegram， Signal）",
    "A set of Nextcloud two-factor providers to send authentication codes via Signal, SMS and Telegram." : "提供 Nextcloud 雙重認證的組合，通過 Signal、短訊（SMS）和 Telegram 發送驗證碼。",
