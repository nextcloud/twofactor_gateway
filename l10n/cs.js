OC.L10N.register(
    ...
    "Failed to verify WhatsApp user." : "Nepodařilo se ověřit WhatsApp uživatele",
    "Failed to send message" : "Nepodařilo se odeslat zprávu",
    "Authentication failed with WhatsApp API. Please verify username/password or log in again." : "Ověření pomocí WhatsApp API se nezdařilo. Zkontrolujte uživatelské jméno / heslo nebo se přihlaste znovu.",
    "WhatsApp device not found or not connected. Please reconfigure the device." : "Zařízení s WhatsApp nenalezeno nebo nepřipojeno. Znovu ho nastavte.",
    ...
    "Channel/Provider" : "Kanál/poskytovatel",
    "Saving …" : "Ukládání …",
    "Save" : "Uložit",
    ...
    "optional" : "volitelné",
    "Cancel" : "Zrušit",
    "Routing settings" : "Nastavení směrování",
    "Instance" : "Instance",
    "Reference" : "Reference",
    "Save routing" : "Uložit směrován",
    "Deleting …" : "Mazání …",
    "Collapse" : "Sbalit",
    "Expand" : "Rozbalit",
    ...
    "Test Gateway" : "Testovací brána",
    "Recipient identifier" : "Identifikátor příjemce",
    "Close" : "Zavřít",
    "Connected account" : "Připojené účty",
    "https://your-gowhatsapp-instance" : "https://vase-instance-gowhatsapp",
    "TwoFactor Gateway" : "Brána pro dvouúrovňové ověřování",
    "API Username:" : "Uživatelské jméno k API:",
    "API Password:" : "Heslo k API:",
    "Device" : "Zařízení",
    "Phone number" : "Telefonní číslo",
    "e.g. 5511999998888" : "např. 5511999998888",
    "Pairing code" : "Párovací kód",
    "Back" : "Zpět",
    "Continue" : "Pokračovat",
    "e.g. http://signal-gateway:8080" : "např. http://signal-gateway:8080",
    "Telegram api_id:" : "Telegram api_id:",
    "From my.telegram.org/apps" : "Od my.telegram.org/apps",
    "Telegram api_hash:" : "Telegram api_hash:",
    "Submit password" : "Odeslat heslo",
    "e.g. {templateName}" : "např. {templateName}",
    "Not selectable" : "Není možné označit",
    "Access token:" : "Přístupový token:",
    "Default: v22.0" : "Výchozí: v22.0",
    "Approved templates" : "Schválené šablony",
    ...
    "e.g. pt_BR" : "např. cs_CZ",
    "Template" : "Šablona",
    "Language" : "Jazyk",
    "Discover templates" : "Objevit šablony",
    ...
    "Enable" : "Povolit",
    "Could not verify your code. Please try again." : "Váš kód se nepodařilo ověřit. Prosíme zkuste to znovu.",
    "Enter your identification (e.g. phone number to start the verification):" : "Pro zahájení ověřování zadejte svou identifikaci (např. telefonní číslo):",
    "Verify" : "Ověřit",
    "A confirmation code has been sent to {phone}. Please insert the code here:" : "Potvrzovací kód byl odeslán do {phone}. Opište ho pak sem:",
    "Confirm" : "Potvrdit",
