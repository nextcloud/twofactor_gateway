OC.L10N.register(
    ...
    "Two-Factor Gateway cannot send WhatsApp verification codes until this is fixed. Reconfigure the GoWhatsApp gateway from the command line using: occ twofactorauth:gateway:configure gowhatsapp" : "O Two-Factor Gateway não pode enviar códigos de verificação do WhatsApp até que isso seja corrigido. Reconfigure o gateway GoWhatsApp a partir da linha de comando usando: occ twofactorauth:gateway:configure gowhatsapp",
    ...
    "Label" : "Rótulo",
    "e.g. Production, Client A …" : "e.x. Produção, Cliente A …",
    "optional" : "opcional",
    "Cancel" : "Cancelar",
