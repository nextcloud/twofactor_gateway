OC.L10N.register(
    ...
    "Two-Factor Gateway: WhatsApp API authentication failed" : "Gateway de dois fatores: Falha na autenticação da API do WhatsApp",
    "The authentication with WhatsApp API has failed. The Two-Factor Gateway (WhatsApp) will not work until this is resolved. Please reconfigure the WhatsApp gateway using the command line tool." : "A autenticação com a API do WhatsApp falhou. O gateway de dois fatores (WhatsApp) não funcionará até que isso seja resolvido. Reconfigure o gateway do WhatsApp usando a ferramenta de linha de comando.",
